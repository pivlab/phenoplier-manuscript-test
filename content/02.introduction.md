...
Understanding how these mechanisms are involved in the development and healing of a wound is crucial for effective treatment strategies.
...
TWAS relies on testing whether perturbations in gene regulatory mechanisms mediate the association between genetic variants and human diseases, including those related to wound healing [@doi:10.1371/journal.pgen.1009482; @doi:10.1038/ng.3506; @doi:10.1371/journal.pgen.1007889; @doi:10.1038/ng.3367].
...
Therefore, integrating genetic studies with gene modules extracted using unsupervised learning could further improve our understanding of disease origin [@pmid:25344726] and progression [@pmid:18631455], especially in the context of wound healing.
...
Additionally, PhenoPLIER can be applied to study the genetic basis of wound healing and tissue repair processes.
